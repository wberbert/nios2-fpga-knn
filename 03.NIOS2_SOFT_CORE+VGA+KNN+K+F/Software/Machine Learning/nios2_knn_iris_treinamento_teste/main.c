...
#define TOTAL_REGISTROS_TREINAMENTO 6
#define TOTAL_REGISTROS_TESTE       144

int g_int_arr_iris_data_treinamento[TOTAL_REGISTROS_TREINAMENTO][5] =    {
                                                                            {51, 35, 14, 2, 1},
                                                                            {49, 30, 14, 2, 1},
                                                                            {70, 32, 47, 14, 2},
                                                                            {64, 32, 45, 15, 2},
...
int g_int_arr_iris_data_teste[TOTAL_REGISTROS_TESTE][5] =           {
                                                                        {47, 32, 13, 2, 1},
                                                                        {46, 31, 15, 2, 1},
                                                                        {50, 36, 14, 2, 1},
                                                                        {54, 39, 17, 4, 1},
...
#define TOTAL_REGISTROS_TREINAMENTO 18
#define TOTAL_REGISTROS_TESTE       132
...
#define TOTAL_REGISTROS_TREINAMENTO 36
#define TOTAL_REGISTROS_TESTE       114
...
#define TOTAL_REGISTROS_TREINAMENTO 54
#define TOTAL_REGISTROS_TESTE       96
...
#define TOTAL_REGISTROS_TREINAMENTO 72
#define TOTAL_REGISTROS_TESTE       78
...
//unsigned short g_sht_output = 0;

int main(int argc, char *argv[])
{

    g_int_knn_k = atoi(argv[1]);

    fnc_testar();

    #ifdef N06
    printf ("6 registros e treinamento 144 registros de teste\n\n");
    #endif // N06

    #ifdef N18
    printf ("18 registros e treinamento 132 registros de teste\n\n");
    #endif // N18

    #ifdef N36
    printf ("36 registros e treinamento 114 registros de teste\n\n");
    #endif // N36

    #ifdef N54
    printf ("54 registros e treinamento 96 registros de teste\n\n");
    #endif // N54

    #ifdef N72
    printf ("72 registros e treinamento 74 registros de teste\n\n");
    #endif // N54
...
int fnc_testar (void) {
    ...
    for (int_loop = 0; int_loop < TOTAL_REGISTROS_TESTE; int_loop++) {
        ...
        if (g_int_arr_dados_teste[4] == g_int_classe_prevista) {
            ...
            printf ("%d\t%d\t%d\t%d\t%d\t0\t0\t0\tClasse prevista %d\t Classe real %d\t %5.7f Segundos X\n", g_int_arr_dados_teste[0], g_int_arr_dados_teste[1], g_int_arr_dados_teste[2], g_int_arr_dados_teste[3], g_int_arr_dados_teste[4], g_int_classe_prevista, g_int_arr_dados_teste[4], (float) g_delta_ms);

        } else {

            printf ("%d\t%d\t%d\t%d\t%d\t0\t0\t0\tClasse prevista %d\t Classe real %d\t %5.7f Segundos  \n", g_int_arr_dados_teste[0], g_int_arr_dados_teste[1], g_int_arr_dados_teste[2], g_int_arr_dados_teste[3], g_int_arr_dados_teste[4], g_int_classe_prevista, g_int_arr_dados_teste[4], (float) g_delta_ms);

        }

    }

    printf ("\n\nTotal de Acertos %d\t Total de Registros %d\t k=%d\n\n", g_int_total_registros_corretos, TOTAL_REGISTROS_TESTE, g_int_knn_k);
...
int fnc_obter_k_proximos(void) {
    ...
    for (int_a =0; int_a < g_int_knn_k; int_a++) {
        int_arr_proximos[int_a][0] = 0;
        int_arr_proximos[int_a][1] = 0;
    }
