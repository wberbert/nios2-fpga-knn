...
#define TOTAL_HARDWARE_TREINAMENTO      18  // TAMANHO DO REGISTRO DE TREINAMENTO DO HARDWARE.
#define TOTAL_HARDWARE_ATRIBUTOS        8   // TOTAL DE ATRIBUTOS MAXIMOS PERMITIDOS NO HARDWARE.
typedef enum {
    RANDOMICO               = 1,
...
void f_contar_classes(int *, distancia_t *, int);
