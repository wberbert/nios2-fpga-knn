...
int g_int_arr_distancias[TOTAL_REGISTROS_TREINAMENTO][2];
int g_int_arr_distancias_ordenadas[TOTAL_REGISTROS_TREINAMENTO][2];
...
int fnc_calcular_distancia_euclidiana (void) {
    ...
    for (int_registro = 0; int_registro < TOTAL_REGISTROS_TREINAMENTO; int_registro ++) {
        ...
        g_int_arr_distancias[int_registro][0] = g_int_arr_iris_data_treinamento[int_registro][TOTAL_ATRIBUTOS - 1]; /*Armazena a classe*/

        for (int_atributo = 0; int_atributo < (TOTAL_ATRIBUTOS - 1); int_atributo++) {

            int_distancia = int_distancia + pow((g_int_arr_dados_teste[int_atributo] - g_int_arr_iris_data_treinamento[int_registro][int_atributo]), 2);
...
int fnc_ordenar(void) {
    ...
    for (int_o = 0; int_o < TOTAL_REGISTROS_TREINAMENTO; int_o++) {

        for (int_i = 0; int_i < ((TOTAL_REGISTROS_TREINAMENTO / 2) -1); int_i++) {
        ...
        for (int_i = 0; int_i < ((TOTAL_REGISTROS_TREINAMENTO / 2)); int_i++) {
...
int fnc_obter_k_proximos(void) {
    ...
    int int_arr_proximos[TOTAL_REGISTROS_TREINAMENTO][2] = {0};
    ...
    for (int_a =0; int_a < KNN_K; int_a++) {
        ...
        for (int_b = 0; int_b < TOTAL_REGISTROS_TREINAMENTO; int_b++) {
    ...
    for (int_a = 0; int_a < TOTAL_REGISTROS_TREINAMENTO; int_a++) {
